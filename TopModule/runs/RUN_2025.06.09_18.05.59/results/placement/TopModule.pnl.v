module TopModule (clk,
 ...
 sky130_fd_sc_hd__and3_1 _1371_ (.A(_1037_),
    ...
    .VPWR(VPWR),
    .X(_1074_));
 sky130_fd_sc_hd__buf_2 _1372_ (.A(_1065_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__and3_2 _1376_ (.A(_1037_),
    ...
    .VPWR(VPWR),
    .X(_1079_));
 sky130_fd_sc_hd__or3_2 _1377_ (.A(_1034_),
    .B(\rf.registers[30][8] ),
    .C(_1075_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _1381_ (.A(_1037_),
    ...
    .VPWR(VPWR),
    .X(_1084_));
 sky130_fd_sc_hd__or3_2 _1382_ (.A(_1034_),
 ...
 sky130_fd_sc_hd__buf_2 _1402_ (.A(_1104_),
    ...
    .VPWR(VPWR),
    .X(_1105_));
 sky130_fd_sc_hd__buf_2 _1403_ (.A(_1065_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_4 _1407_ (.A(_1067_),
    ...
    .VPWR(VPWR),
    .X(_1110_));
 sky130_fd_sc_hd__o21a_1 _1408_ (.A1(_1096_),
    .A2(_1098_),
 ...
 sky130_fd_sc_hd__buf_4 _1426_ (.A(_1075_),
    ...
    .VPWR(VPWR),
    .X(_1129_));
 sky130_fd_sc_hd__or3_1 _1427_ (.A(_1035_),
    ...
    .VPWR(VPWR),
    .X(_1130_));
 sky130_fd_sc_hd__o31a_2 _1428_ (.A1(_1110_),
    .A2(_1127_),
    .A3(_1128_),
    .B1(_1130_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _1430_ (.A(_1039_),
    ...
    .VPWR(VPWR),
    .X(_1133_));
 sky130_fd_sc_hd__or3_2 _1431_ (.A(_1035_),
 ...
 sky130_fd_sc_hd__mux2_2 _1443_ (.A0(\rf.registers[5][7] ),
    ...
    .VPWR(VPWR),
    .X(_1146_));
 sky130_fd_sc_hd__clkbuf_4 _1444_ (.A(_1060_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 _1480_ (.A(_1129_),
    ...
    .VPWR(VPWR),
    .X(_1183_));
 sky130_fd_sc_hd__or3_2 _1481_ (.A(_1182_),
 ...
 sky130_fd_sc_hd__o31a_2 _1482_ (.A1(_1175_),
    ...
    .VPWR(VPWR),
    .X(_1185_));
 sky130_fd_sc_hd__or4_2 _1483_ (.A(_1162_),
    .B(_1168_),
    .C(_1174_),
    .D(_1185_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o31a_2 _1499_ (.A1(_1175_),
    ...
    .VPWR(VPWR),
    .X(_1202_));
 sky130_fd_sc_hd__or4_2 _1500_ (.A(_1190_),
    .B(_1194_),
    .C(_1198_),
    .D(_1202_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_2 _1506_ (.A(_1165_),
    ...
    .VPWR(VPWR),
    .X(_1209_));
 sky130_fd_sc_hd__or3_2 _1507_ (.A(_1182_),
 ...
 sky130_fd_sc_hd__or3_2 _1512_ (.A(_1036_),
    ...
    .VPWR(VPWR),
    .X(_1215_));
 sky130_fd_sc_hd__o31a_2 _1513_ (.A1(_1175_),
    .A2(_1212_),
    .A3(_1213_),
    .B1(_1215_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _1545_ (.A(_1038_),
    ...
    .VPWR(VPWR),
    .X(_1248_));
 sky130_fd_sc_hd__or3_2 _1546_ (.A(_1104_),
    .B(\rf.registers[30][2] ),
    .C(_1106_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o31a_2 _1553_ (.A1(_1093_),
    ...
    .VPWR(VPWR),
    .X(_1256_));
 sky130_fd_sc_hd__buf_4 _1554_ (.A(_1256_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__or3_4 _1610_ (.A(_1226_),
    ...
    .VPWR(VPWR),
    .X(_1312_));
 sky130_fd_sc_hd__clkbuf_4 _1611_ (.A(_1224_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _1645_ (.A(_1217_),
    ...
    .VPWR(VPWR),
    .X(_0206_));
 sky130_fd_sc_hd__o221a_2 _1646_ (.A1(\rf.registers[30][7] ),
    .A2(_1242_),
    .B1(_1153_),
    .B2(_0195_),
    .C1(_0206_),
 ...
 sky130_fd_sc_hd__mux2_2 _1669_ (.A0(\rf.registers[25][8] ),
    ...
    .VPWR(VPWR),
    .X(_0230_));
 sky130_fd_sc_hd__xnor2_4 _1670_ (.A(_1081_),
    .B(_0208_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_4 _1683_ (.A0(_0241_),
    ...
    .VPWR(VPWR),
    .X(_0244_));
 sky130_fd_sc_hd__nand2_2 _1684_ (.A(_1313_),
    .B(_0199_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or4_4 _1702_ (.A(_1092_),
    ...
    .VPWR(VPWR),
    .X(_0262_));
 sky130_fd_sc_hd__buf_4 _1703_ (.A(_0262_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__a21boi_4 _1717_ (.A1(_1086_),
    ...
    .VPWR(VPWR),
    .Y(_0277_));
 sky130_fd_sc_hd__o21a_2 _1718_ (.A1(_1291_),
    .A2(_0277_),
    .B1(_0268_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _1722_ (.A(_1077_),
    ...
    .VPWR(VPWR),
    .X(_0282_));
 sky130_fd_sc_hd__or4_2 _1723_ (.A(_0282_),
    .B(_1155_),
    .C(_0190_),
    .D(_0194_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0283_));
 sky130_fd_sc_hd__xnor2_2 _1724_ (.A(_1091_),
    .B(_0283_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_4 _1728_ (.A0(\rf.registers[25][9] ),
    ...
    .VPWR(VPWR),
    .X(_0288_));
 sky130_fd_sc_hd__or4_2 _1729_ (.A(_1081_),
    .B(_1155_),
    .C(_0191_),
    .D(_0194_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_4 _1733_ (.A(_0288_),
    ...
    .VPWR(VPWR),
    .X(_0293_));
 sky130_fd_sc_hd__and2_2 _1734_ (.A(_0292_),
    .B(_0293_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__buf_4 _1746_ (.A(_0185_),
    ...
    .VPWR(VPWR),
    .X(_0306_));
 sky130_fd_sc_hd__clkbuf_4 _1747_ (.A(_0240_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0307_));
 sky130_fd_sc_hd__nand2_2 _1748_ (.A(_0307_),
    .B(_0274_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0308_));
 sky130_fd_sc_hd__nand2_2 _1749_ (.A(_0307_),
    .B(_0259_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__buf_4 _1757_ (.A(_0183_),
    ...
    .VPWR(VPWR),
    .X(_0317_));
 sky130_fd_sc_hd__mux2_1 _1758_ (.A0(_0248_),
    .A1(_0316_),
    .S(_0317_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _1776_ (.A0(_1314_),
    ...
    .VPWR(VPWR),
    .X(_0334_));
 sky130_fd_sc_hd__mux2_2 _1777_ (.A0(_0333_),
    .A1(_0334_),
    .S(_1231_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21a_2 _1789_ (.A1(_1257_),
    ...
    .VPWR(VPWR),
    .X(_0346_));
 sky130_fd_sc_hd__nor2_1 _1790_ (.A(_0185_),
    .B(_0346_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0347_));
 sky130_fd_sc_hd__or2_2 _1791_ (.A(_0340_),
    .B(_0347_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_2 _1811_ (.A0(_0365_),
    ...
    .VPWR(VPWR),
    .X(_0367_));
 sky130_fd_sc_hd__mux2_1 _1812_ (.A0(_0343_),
    .A1(_0367_),
    .S(_0317_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or2_2 _1846_ (.A(_1109_),
    ...
    .VPWR(VPWR),
    .X(_0398_));
 sky130_fd_sc_hd__or3_2 _1847_ (.A(_0398_),
    .B(_1121_),
    .C(_0263_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_2 _1848_ (.A1(_0398_),
    ...
    .VPWR(VPWR),
    .Y(_0400_));
 sky130_fd_sc_hd__a21o_2 _1849_ (.A1(_0399_),
    .A2(_0400_),
    .B1(_0260_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_2 _1853_ (.A(_0403_),
    ...
    .VPWR(VPWR),
    .Y(_0405_));
 sky130_fd_sc_hd__o21a_1 _1854_ (.A1(_0403_),
    .A2(_0404_),
    .B1(_0188_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_2 _1858_ (.A0(_0381_),
    ...
    .VPWR(VPWR),
    .X(_0410_));
 sky130_fd_sc_hd__nor2_2 _1859_ (.A(_0239_),
    .B(_0410_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _1860_ (.A1(_0405_),
    ...
    .VPWR(VPWR),
    .X(_0412_));
 sky130_fd_sc_hd__buf_4 _1861_ (.A(_0412_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _1882_ (.A(_0306_),
    ...
    .VPWR(VPWR),
    .Y(_0431_));
 sky130_fd_sc_hd__a21o_2 _1883_ (.A1(_0362_),
    .A2(_0427_),
    .B1(_0431_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_2 _1884_ (.A(_0397_),
    ...
    .VPWR(VPWR),
    .X(_0432_));
 sky130_fd_sc_hd__a21oi_2 _1885_ (.A1(_0403_),
    .A2(_0404_),
    .B1(_0432_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0433_));
 sky130_fd_sc_hd__nor2_2 _1886_ (.A(_1126_),
    .B(_0263_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o31a_2 _1887_ (.A1(_0398_),
    ...
    .VPWR(VPWR),
    .X(_0435_));
 sky130_fd_sc_hd__o21a_2 _1888_ (.A1(_0434_),
    .A2(_0435_),
    .B1(_0213_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or3_2 _1892_ (.A(_0203_),
    ...
    .VPWR(VPWR),
    .X(_0440_));
 sky130_fd_sc_hd__and2_1 _1893_ (.A(_0439_),
    .B(_0440_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _1894_ (.A(_0433_),
    ...
    .VPWR(VPWR),
    .Y(_0442_));
 sky130_fd_sc_hd__clkbuf_4 _1895_ (.A(_0240_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__a22o_1 _1914_ (.A1(net31),
    ...
    .VPWR(VPWR),
    .X(_0461_));
 sky130_fd_sc_hd__a31o_1 _1915_ (.A1(_0007_),
    .A2(_0456_),
    .A3(net4),
    .B1(_0461_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a211oi_4 _1924_ (.A1(net9),
    ...
    .VPWR(VPWR),
    .Y(_0471_));
 sky130_fd_sc_hd__buf_2 _1925_ (.A(_0471_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _1948_ (.A1(_0478_),
    ...
    .VPWR(VPWR),
    .Y(_0489_));
 sky130_fd_sc_hd__or3_2 _1949_ (.A(_0464_),
    .B(_0472_),
    .C(_0482_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_4 _1952_ (.A0(\rf.registers[25][16] ),
    ...
    .VPWR(VPWR),
    .X(_0492_));
 sky130_fd_sc_hd__or3_2 _1953_ (.A(_1126_),
    .B(_1131_),
    .C(_0262_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _2070_ (.A(_1139_),
    ...
    .VPWR(VPWR),
    .Y(_0609_));
 sky130_fd_sc_hd__or2_4 _2071_ (.A(_1139_),
    .B(_0493_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_2 _2136_ (.A(_0670_),
    ...
    .VPWR(VPWR),
    .X(_0672_));
 sky130_fd_sc_hd__and3_2 _2137_ (.A(_0636_),
    .B(_0657_),
    .C(_0658_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o31ai_4 _2155_ (.A1(_1168_),
    ...
    .VPWR(VPWR),
    .Y(_0690_));
 sky130_fd_sc_hd__a21o_2 _2156_ (.A1(_0689_),
    .A2(_0690_),
    .B1(_0260_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_4 _2174_ (.A(_0517_),
    ...
    .VPWR(VPWR),
    .Y(_0708_));
 sky130_fd_sc_hd__or2_2 _2175_ (.A(_0517_),
    .B(_0707_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a31o_4 _2186_ (.A1(_0505_),
    ...
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__nand2_4 _2187_ (.A(_0708_),
    .B(_0712_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_2 _2201_ (.A1(_0608_),
    ...
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__or2_2 _2202_ (.A(_1202_),
    .B(_0721_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _2249_ (.A(_0778_),
    ...
    .VPWR(VPWR),
    .Y(_0779_));
 sky130_fd_sc_hd__nor2_2 _2250_ (.A(_0738_),
    .B(_0764_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_2 _2251_ (.A1(_0569_),
    ...
    .VPWR(VPWR),
    .X(_0781_));
 sky130_fd_sc_hd__o21ba_2 _2252_ (.A1(_0748_),
    .A2(_0764_),
    .B1_N(_0781_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _2305_ (.A1(_1162_),
    ...
    .VPWR(VPWR),
    .Y(_0832_));
 sky130_fd_sc_hd__nand2_1 _2306_ (.A(_0831_),
    .B(_0832_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2b_1 _2324_ (.A(_0848_),
    ...
    .VPWR(VPWR),
    .X(_0850_));
 sky130_fd_sc_hd__a21o_1 _2325_ (.A1(_0760_),
    .A2(_0850_),
    .B1(_0813_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_4 _2326_ (.A(_0593_),
    ...
    .VPWR(VPWR),
    .X(_0852_));
 sky130_fd_sc_hd__nor2_1 _2327_ (.A(_0593_),
    .B(_0851_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _2425_ (.A0(net26),
    ...
    .VPWR(VPWR),
    .X(_0914_));
 sky130_fd_sc_hd__buf_1 _2426_ (.A(_0914_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _2427_ (.A1(_1040_),
    ...
    .VPWR(VPWR),
    .X(_0915_));
 sky130_fd_sc_hd__o31a_2 _2428_ (.A1(_0877_),
    .A2(_0867_),
    .A3(_0874_),
    .B1(_0915_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__buf_4 _2590_ (.A(_0956_),
    ...
    .VPWR(VPWR),
    .X(_0986_));
 sky130_fd_sc_hd__mux2_2 _2591_ (.A0(\rf.registers[0][23] ),
    .A1(net18),
    .S(_0986_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__buf_1 _2600_ (.A(_0991_),
    ...
    .VPWR(VPWR),
    .X(_0140_));
 sky130_fd_sc_hd__mux2_2 _2601_ (.A0(\rf.registers[0][28] ),
    .A1(net23),
    .S(_0961_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _2605_ (.A0(\rf.registers[0][30] ),
    ...
    .VPWR(VPWR),
    .X(_0994_));
 sky130_fd_sc_hd__clkbuf_2 _2606_ (.A(_0994_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_1 _2812_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(net45));
 sky130_fd_sc_hd__dfxtp_2 _2813_ (.CLK(clk),
    .D(_0145_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_1 _2814_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(\rf.registers[5][1] ));
 sky130_fd_sc_hd__dfxtp_1 _2815_ (.CLK(clk),
    .D(_0147_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\rf.registers[5][2] ));
 sky130_fd_sc_hd__dfxtp_2 _2816_ (.CLK(clk),
    .D(_0148_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__buf_1 output45 (.A(net45),
    ...
    .VPWR(VPWR),
    .X(seg[6]));
 sky130_fd_sc_hd__buf_4 wire46 (.A(_1060_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
