module TopModule (clk,
 ...
 sky130_fd_sc_hd__buf_4 _1323_ (.A(\imem.addr[2] ),
    ...
    .VPWR(VPWR),
    .X(_1031_));
 sky130_fd_sc_hd__buf_4 _1324_ (.A(\imem.addr[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 _1345_ (.A(_1048_),
    ...
    .VPWR(VPWR),
    .X(_0007_));
 sky130_fd_sc_hd__nor4b_2 _1346_ (.A(_1029_),
    .B(\imem.addr[2] ),
    .C(\imem.addr[0] ),
    .D_N(\imem.addr[1] ),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21a_4 _1356_ (.A1(_1032_),
    ...
    .VPWR(VPWR),
    .X(_1059_));
 sky130_fd_sc_hd__a2111oi_4 _1357_ (.A1(_1056_),
    .A2(net47),
    .B1(_1030_),
    .C1(_1052_),
    .D1(_1059_),
 ...
 sky130_fd_sc_hd__and3_1 _1371_ (.A(_1037_),
    ...
    .VPWR(VPWR),
    .X(_1074_));
 sky130_fd_sc_hd__clkbuf_4 _1372_ (.A(_1065_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1075_));
 sky130_fd_sc_hd__or3_2 _1373_ (.A(_1034_),
    .B(\rf.registers[30][9] ),
    .C(_1075_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _1381_ (.A(_1037_),
    ...
    .VPWR(VPWR),
    .X(_1084_));
 sky130_fd_sc_hd__or3_1 _1382_ (.A(_1034_),
    ...
    .VPWR(VPWR),
    .X(_1085_));
 sky130_fd_sc_hd__o31a_2 _1383_ (.A1(_1067_),
    .A2(_1083_),
    .A3(_1084_),
    .B1(_1085_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or3_1 _1387_ (.A(_1034_),
    ...
    .VPWR(VPWR),
    .X(_1090_));
 sky130_fd_sc_hd__o31a_2 _1388_ (.A1(_1067_),
    .A2(_1087_),
    .A3(_1089_),
    .B1(_1090_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1091_));
 sky130_fd_sc_hd__or4_4 _1389_ (.A(_1077_),
    .B(_1081_),
    .C(_1086_),
    .D(_1091_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__buf_4 _1402_ (.A(_1104_),
    ...
    .VPWR(VPWR),
    .X(_1105_));
 sky130_fd_sc_hd__clkbuf_4 _1403_ (.A(_1065_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 _1404_ (.A(_1106_),
    ...
    .VPWR(VPWR),
    .X(_1107_));
 sky130_fd_sc_hd__or3_1 _1405_ (.A(_1105_),
    ...
    .VPWR(VPWR),
    .X(_1108_));
 sky130_fd_sc_hd__o31a_2 _1406_ (.A1(_1094_),
    .A2(_1099_),
    .A3(_1103_),
    .B1(_1108_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_2 _1409_ (.A(_1039_),
    ...
    .VPWR(VPWR),
    .X(_1112_));
 sky130_fd_sc_hd__or3_2 _1410_ (.A(_1105_),
    ...
    .VPWR(VPWR),
    .X(_1113_));
 sky130_fd_sc_hd__o31a_2 _1411_ (.A1(_1110_),
    .A2(_1111_),
    .A3(_1112_),
    .B1(_1113_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _1416_ (.A(_1101_),
    ...
    .VPWR(VPWR),
    .X(_1119_));
 sky130_fd_sc_hd__or3_2 _1417_ (.A(_1105_),
 ...
 sky130_fd_sc_hd__and3_2 _1420_ (.A(_1101_),
    ...
    .VPWR(VPWR),
    .X(_1123_));
 sky130_fd_sc_hd__or3_2 _1421_ (.A(_1105_),
    ...
    .VPWR(VPWR),
    .X(_1124_));
 sky130_fd_sc_hd__o31a_2 _1422_ (.A1(_1094_),
    .A2(_1122_),
    .A3(_1123_),
    .B1(_1124_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__buf_2 _1426_ (.A(_1075_),
    ...
    .VPWR(VPWR),
    .X(_1129_));
 sky130_fd_sc_hd__or3_2 _1427_ (.A(_1035_),
 ...
 sky130_fd_sc_hd__and3_1 _1434_ (.A(_1039_),
    ...
    .VPWR(VPWR),
    .X(_1137_));
 sky130_fd_sc_hd__or3_2 _1435_ (.A(_1035_),
    ...
    .VPWR(VPWR),
    .X(_1138_));
 sky130_fd_sc_hd__o31a_2 _1436_ (.A1(_1110_),
    .A2(_1136_),
    .A3(_1137_),
    .B1(_1138_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _1438_ (.A(_1101_),
    ...
    .VPWR(VPWR),
    .X(_1141_));
 sky130_fd_sc_hd__or3_2 _1439_ (.A(_1105_),
 ...
 sky130_fd_sc_hd__o31a_2 _1440_ (.A1(_1094_),
    ...
    .VPWR(VPWR),
    .X(_1143_));
 sky130_fd_sc_hd__or4_2 _1441_ (.A(_1131_),
    .B(_1135_),
    .C(_1139_),
    .D(_1143_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__mux2_2 _1443_ (.A0(\rf.registers[5][7] ),
    ...
    .VPWR(VPWR),
    .X(_1146_));
 sky130_fd_sc_hd__buf_4 _1444_ (.A(_1060_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _1469_ (.A(_1165_),
    ...
    .VPWR(VPWR),
    .X(_1172_));
 sky130_fd_sc_hd__or3_2 _1470_ (.A(_1159_),
 ...
 sky130_fd_sc_hd__or3_1 _1481_ (.A(_1182_),
    ...
    .VPWR(VPWR),
    .X(_1184_));
 sky130_fd_sc_hd__o31a_2 _1482_ (.A1(_1175_),
    .A2(_1178_),
    .A3(_1181_),
    .B1(_1184_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _1493_ (.A(_1179_),
    ...
    .VPWR(VPWR),
    .X(_1196_));
 sky130_fd_sc_hd__or3_2 _1494_ (.A(_1182_),
 ...
 sky130_fd_sc_hd__and3_1 _1497_ (.A(_1179_),
    ...
    .VPWR(VPWR),
    .X(_1200_));
 sky130_fd_sc_hd__or3_2 _1498_ (.A(_1182_),
 ...
 sky130_fd_sc_hd__o31a_2 _1499_ (.A1(_1175_),
    ...
    .VPWR(VPWR),
    .X(_1202_));
 sky130_fd_sc_hd__or4_1 _1500_ (.A(_1190_),
    .B(_1194_),
    .C(_1198_),
    .D(_1202_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_4 _1511_ (.A(_1129_),
    ...
    .VPWR(VPWR),
    .X(_1214_));
 sky130_fd_sc_hd__or3_2 _1512_ (.A(_1036_),
 ...
 sky130_fd_sc_hd__o31a_4 _1518_ (.A1(_1217_),
    ...
    .VPWR(VPWR),
    .X(_1221_));
 sky130_fd_sc_hd__or4_2 _1519_ (.A(_1207_),
    .B(_1211_),
    .C(_1216_),
    .D(_1221_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1222_));
 sky130_fd_sc_hd__or4_2 _1520_ (.A(_1155_),
    .B(_1186_),
    .C(_1203_),
    .D(_1222_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1223_));
 sky130_fd_sc_hd__nor4_4 _1521_ (.A(_1092_),
    .B(_1126_),
    .C(_1144_),
    .D(_1223_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_2 _1545_ (.A(_1038_),
    ...
    .VPWR(VPWR),
    .X(_1248_));
 sky130_fd_sc_hd__or3_1 _1546_ (.A(_1104_),
    .B(\rf.registers[30][2] ),
    .C(_1106_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1249_));
 sky130_fd_sc_hd__o31a_2 _1547_ (.A1(_1067_),
    .A2(_1247_),
    .A3(_1248_),
    .B1(_1249_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or3_4 _1552_ (.A(_1104_),
    ...
    .VPWR(VPWR),
    .X(_1255_));
 sky130_fd_sc_hd__o31a_2 _1553_ (.A1(_1093_),
    .A2(_1253_),
    .A3(_1254_),
    .B1(_1255_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _1590_ (.A1(_1236_),
    ...
    .VPWR(VPWR),
    .X(_1292_));
 sky130_fd_sc_hd__clkbuf_4 _1591_ (.A(_1235_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 _1609_ (.A(_1293_),
    ...
    .VPWR(VPWR),
    .X(_1311_));
 sky130_fd_sc_hd__or3_2 _1610_ (.A(_1226_),
    .B(_1310_),
    .C(_1311_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1312_));
 sky130_fd_sc_hd__buf_4 _1611_ (.A(_1224_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__mux2_4 _1615_ (.A0(_1314_),
    ...
    .VPWR(VPWR),
    .X(_1317_));
 sky130_fd_sc_hd__nand2_2 _1616_ (.A(_1224_),
    .B(_1271_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1318_));
 sky130_fd_sc_hd__nand2_4 _1617_ (.A(_1224_),
    .B(_1277_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or4_4 _1629_ (.A(_1230_),
    ...
    .VPWR(VPWR),
    .X(_0190_));
 sky130_fd_sc_hd__clkbuf_8 _1630_ (.A(_0190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _1661_ (.A(_0220_),
    ...
    .VPWR(VPWR),
    .Y(_0222_));
 sky130_fd_sc_hd__a211o_2 _1662_ (.A1(_1300_),
    .A2(_0202_),
    .B1(_0217_),
    .C1(_0222_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_4 _1678_ (.A(_0185_),
    ...
    .VPWR(VPWR),
    .X(_0239_));
 sky130_fd_sc_hd__clkbuf_4 _1679_ (.A(_1313_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__mux2_2 _1683_ (.A0(_0241_),
    ...
    .VPWR(VPWR),
    .X(_0244_));
 sky130_fd_sc_hd__nand2_4 _1684_ (.A(_1313_),
    .B(_0199_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_2 _1691_ (.A1(_1309_),
    ...
    .VPWR(VPWR),
    .X(_0252_));
 sky130_fd_sc_hd__nor2_2 _1692_ (.A(_0239_),
    .B(_0252_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__buf_4 _1701_ (.A(_0260_),
    ...
    .VPWR(VPWR),
    .X(_0261_));
 sky130_fd_sc_hd__or4_4 _1702_ (.A(_1092_),
    .B(_1154_),
    .C(_0190_),
    .D(_0193_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__buf_4 _1704_ (.A(_0263_),
    ...
    .VPWR(VPWR),
    .X(_0264_));
 sky130_fd_sc_hd__nor2_2 _1705_ (.A(_1109_),
    .B(_0264_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or4_4 _1723_ (.A(_0282_),
    ...
    .VPWR(VPWR),
    .X(_0283_));
 sky130_fd_sc_hd__xnor2_1 _1724_ (.A(_1091_),
    .B(_0283_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_4 _1728_ (.A0(\rf.registers[25][9] ),
    ...
    .VPWR(VPWR),
    .X(_0288_));
 sky130_fd_sc_hd__or4_1 _1729_ (.A(_1081_),
    .B(_1155_),
    .C(_0191_),
    .D(_0194_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__buf_4 _1746_ (.A(_0185_),
    ...
    .VPWR(VPWR),
    .X(_0306_));
 sky130_fd_sc_hd__clkbuf_8 _1747_ (.A(_0240_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__nand2_4 _1753_ (.A(_0307_),
    ...
    .VPWR(VPWR),
    .Y(_0313_));
 sky130_fd_sc_hd__mux2_1 _1754_ (.A0(_0312_),
    .A1(_0313_),
    .S(_0243_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_2 _1760_ (.A0(_0184_),
    ...
    .VPWR(VPWR),
    .X(_0320_));
 sky130_fd_sc_hd__nor2_2 _1761_ (.A(_0306_),
    .B(_0320_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0321_));
 sky130_fd_sc_hd__a21o_2 _1762_ (.A1(_0304_),
    .A2(_0305_),
    .B1(_0321_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_4 _1780_ (.A1(_0328_),
    ...
    .VPWR(VPWR),
    .Y(net30));
 sky130_fd_sc_hd__or3_2 _1781_ (.A(_0233_),
    .B(_0237_),
    .C(_0294_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _1783_ (.A(_0188_),
    ...
    .VPWR(VPWR),
    .X(_0340_));
 sky130_fd_sc_hd__mux2_1 _1784_ (.A0(_0242_),
    .A1(_0312_),
    .S(_1316_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or3_1 _1788_ (.A(_1251_),
    ...
    .VPWR(VPWR),
    .X(_0345_));
 sky130_fd_sc_hd__o21a_1 _1789_ (.A1(_1257_),
    .A2(_0344_),
    .B1(_0345_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_2 _1790_ (.A(_0185_),
    ...
    .VPWR(VPWR),
    .Y(_0347_));
 sky130_fd_sc_hd__or2_1 _1791_ (.A(_0340_),
    .B(_0347_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0348_));
 sky130_fd_sc_hd__buf_2 _1792_ (.A(_0348_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_4 _1793_ (.A(_0225_),
    ...
    .VPWR(VPWR),
    .X(_0349_));
 sky130_fd_sc_hd__xnor2_1 _1794_ (.A(_1114_),
    .B(_0265_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or3_2 _1802_ (.A(_0357_),
    ...
    .VPWR(VPWR),
    .X(_0358_));
 sky130_fd_sc_hd__and2_2 _1803_ (.A(_0356_),
    .B(_0358_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_2 _1808_ (.A(_0307_),
    ...
    .VPWR(VPWR),
    .Y(_0364_));
 sky130_fd_sc_hd__mux2_2 _1809_ (.A0(_0309_),
    .A1(_0364_),
    .S(_0310_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0365_));
 sky130_fd_sc_hd__mux2_2 _1810_ (.A0(_0308_),
    .A1(_0313_),
    .S(_1311_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_2 _1812_ (.A0(_0343_),
    ...
    .VPWR(VPWR),
    .X(_0368_));
 sky130_fd_sc_hd__mux2_2 _1813_ (.A0(_0336_),
    .A1(_0368_),
    .S(_0319_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0369_));
 sky130_fd_sc_hd__nor2_2 _1814_ (.A(_0306_),
    .B(_0369_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0370_));
 sky130_fd_sc_hd__a21o_1 _1815_ (.A1(_0361_),
    .A2(_0363_),
    .B1(_0370_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0371_));
 sky130_fd_sc_hd__buf_4 _1816_ (.A(_0371_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _1826_ (.A0(_1317_),
    ...
    .VPWR(VPWR),
    .X(_0380_));
 sky130_fd_sc_hd__mux2_2 _1827_ (.A0(_0378_),
    .A1(_0380_),
    .S(_0182_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0381_));
 sky130_fd_sc_hd__nor2_2 _1828_ (.A(_0377_),
    .B(_0381_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21bo_1 _1834_ (.A1(_0376_),
    ...
    .VPWR(VPWR),
    .X(_0388_));
 sky130_fd_sc_hd__buf_2 _1835_ (.A(_0388_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__mux4_2 _1840_ (.A0(_1317_),
    ...
    .VPWR(VPWR),
    .X(_0393_));
 sky130_fd_sc_hd__o22a_2 _1841_ (.A1(_0391_),
    .A2(_0378_),
    .B1(_0393_),
    .B2(_1309_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0394_));
 sky130_fd_sc_hd__nor2_2 _1842_ (.A(_0239_),
    .B(_0394_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0395_));
 sky130_fd_sc_hd__a21o_2 _1843_ (.A1(_0362_),
    .A2(_0390_),
    .B1(_0395_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux4_2 _1857_ (.A0(_0244_),
    ...
    .VPWR(VPWR),
    .X(_0409_));
 sky130_fd_sc_hd__mux2_2 _1858_ (.A0(_0381_),
    .A1(_0409_),
    .S(_0250_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0410_));
 sky130_fd_sc_hd__nor2_1 _1859_ (.A(_0239_),
    .B(_0410_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_4 _1876_ (.A(_0421_),
    ...
    .VPWR(VPWR),
    .Y(net32));
 sky130_fd_sc_hd__a21oi_4 _1877_ (.A1(_0286_),
    .A2(_0389_),
    .B1(_0299_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o22a_2 _1881_ (.A1(_0391_),
    ...
    .VPWR(VPWR),
    .X(_0430_));
 sky130_fd_sc_hd__nor2_2 _1882_ (.A(_0306_),
    .B(_0430_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_4 _1885_ (.A1(_0403_),
    ...
    .VPWR(VPWR),
    .Y(_0433_));
 sky130_fd_sc_hd__nor2_1 _1886_ (.A(_1126_),
    .B(_0263_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ai_2 _1891_ (.A1(_0189_),
    ...
    .VPWR(VPWR),
    .Y(_0439_));
 sky130_fd_sc_hd__or3_2 _1892_ (.A(_0203_),
    .B(_0438_),
    .C(_0436_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0440_));
 sky130_fd_sc_hd__and2_2 _1893_ (.A(_0439_),
    .B(_0440_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_2 _1896_ (.A(_0443_),
    ...
    .VPWR(VPWR),
    .Y(_0444_));
 sky130_fd_sc_hd__mux2_2 _1897_ (.A0(_0407_),
    .A1(_0444_),
    .S(_0310_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_2 _1900_ (.A0(_0428_),
    ...
    .VPWR(VPWR),
    .X(_0448_));
 sky130_fd_sc_hd__mux2_2 _1901_ (.A0(_0424_),
    .A1(_0448_),
    .S(_0319_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0449_));
 sky130_fd_sc_hd__nor2_2 _1902_ (.A(_0306_),
    .B(_0449_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a22o_1 _1914_ (.A1(net31),
    ...
    .VPWR(VPWR),
    .X(_0461_));
 sky130_fd_sc_hd__a31o_2 _1915_ (.A1(_0007_),
    .A2(_0456_),
    .A3(net4),
    .B1(_0461_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a22o_4 _1918_ (.A1(net30),
    ...
    .VPWR(VPWR),
    .X(_0465_));
 sky130_fd_sc_hd__and3_4 _1919_ (.A(_0007_),
    .B(_0456_),
    .C(net34),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_2 _1927_ (.A1(_0464_),
    ...
    .VPWR(VPWR),
    .Y(_0474_));
 sky130_fd_sc_hd__o211a_1 _1928_ (.A1(_0459_),
    .A2(_0468_),
    .B1(_0472_),
    .C1(_0474_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0475_));
 sky130_fd_sc_hd__or4_2 _1929_ (.A(_0459_),
    .B(_0464_),
    .C(_0473_),
    .D(_0472_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__buf_4 _1931_ (.A(_0463_),
    ...
    .VPWR(VPWR),
    .X(_0478_));
 sky130_fd_sc_hd__or3b_2 _1932_ (.A(_0472_),
    .B(_0477_),
    .C_N(_0478_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_4 _1935_ (.A1(_0458_),
    ...
    .VPWR(VPWR),
    .Y(_0481_));
 sky130_fd_sc_hd__nand2_2 _1936_ (.A(_0459_),
    .B(_0467_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_8 _1952_ (.A0(\rf.registers[25][16] ),
    ...
    .VPWR(VPWR),
    .X(_0492_));
 sky130_fd_sc_hd__or3_4 _1953_ (.A(_1126_),
    .B(_1131_),
    .C(_0262_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0493_));
 sky130_fd_sc_hd__o21ai_2 _1954_ (.A1(_1126_),
    .A2(_0264_),
    .B1(_1131_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0494_));
 sky130_fd_sc_hd__a21oi_2 _1955_ (.A1(_0493_),
    .A2(_0494_),
    .B1(_0260_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_2 _2070_ (.A(_1139_),
    ...
    .VPWR(VPWR),
    .Y(_0609_));
 sky130_fd_sc_hd__or2_2 _2071_ (.A(_1139_),
    .B(_0493_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 _2095_ (.A(_0213_),
    ...
    .VPWR(VPWR),
    .X(_0633_));
 sky130_fd_sc_hd__xnor2_1 _2096_ (.A(_1135_),
    .B(_0610_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a31o_4 _2100_ (.A1(_0497_),
    ...
    .VPWR(VPWR),
    .X(_0638_));
 sky130_fd_sc_hd__xor2_4 _2101_ (.A(_0636_),
    .B(_0638_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_2 _2115_ (.A1(_0636_),
    ...
    .VPWR(VPWR),
    .Y(_0652_));
 sky130_fd_sc_hd__o21a_1 _2116_ (.A1(_1135_),
    .A2(_0610_),
    .B1(_1143_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0653_));
 sky130_fd_sc_hd__or2_4 _2117_ (.A(_1126_),
    .B(_1144_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0654_));
 sky130_fd_sc_hd__nor2_2 _2118_ (.A(_0654_),
    .B(_0264_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ai_4 _2120_ (.A1(_0349_),
    ...
    .VPWR(VPWR),
    .Y(_0657_));
 sky130_fd_sc_hd__or3_2 _2121_ (.A(_0357_),
    .B(_0545_),
    .C(_0656_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_4 _2136_ (.A(_0670_),
    ...
    .VPWR(VPWR),
    .X(_0672_));
 sky130_fd_sc_hd__and3_1 _2137_ (.A(_0636_),
    .B(_0657_),
    .C(_0658_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0673_));
 sky130_fd_sc_hd__and3_1 _2138_ (.A(_0497_),
    .B(_0614_),
    .C(_0673_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o31ai_4 _2155_ (.A1(_1168_),
    ...
    .VPWR(VPWR),
    .Y(_0690_));
 sky130_fd_sc_hd__a21o_1 _2156_ (.A1(_0689_),
    .A2(_0690_),
    .B1(_0260_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xnor2_2 _2172_ (.A(_1211_),
    ...
    .VPWR(VPWR),
    .Y(_0706_));
 sky130_fd_sc_hd__a21o_2 _2173_ (.A1(_0213_),
    .A2(_0706_),
    .B1(_0189_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_4 _2176_ (.A(_0708_),
    ...
    .VPWR(VPWR),
    .X(_0710_));
 sky130_fd_sc_hd__or4_2 _2177_ (.A(_0705_),
    .B(_0695_),
    .C(_0697_),
    .D(_0710_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o22a_1 _2185_ (.A1(_0618_),
    ...
    .VPWR(VPWR),
    .X(_0719_));
 sky130_fd_sc_hd__a31o_2 _2186_ (.A1(_0505_),
    .A2(_0711_),
    .A3(_0712_),
    .B1(_0719_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__nand2_2 _2187_ (.A(_0708_),
    .B(_0712_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_4 _2190_ (.A1(_0721_),
    ...
    .VPWR(VPWR),
    .Y(_0723_));
 sky130_fd_sc_hd__o21a_2 _2191_ (.A1(_0357_),
    .A2(_0723_),
    .B1(_0523_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0724_));
 sky130_fd_sc_hd__nor3_2 _2192_ (.A(_0357_),
    .B(_0523_),
    .C(_0723_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0725_));
 sky130_fd_sc_hd__nor2_2 _2193_ (.A(_0724_),
    .B(_0725_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _2209_ (.A(_0740_),
    ...
    .VPWR(VPWR),
    .Y(_0741_));
 sky130_fd_sc_hd__o211a_1 _2210_ (.A1(_0705_),
    .A2(_0695_),
    .B1(_0710_),
    .C1(_0726_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_2 _2214_ (.A(_0744_),
    ...
    .VPWR(VPWR),
    .Y(_0746_));
 sky130_fd_sc_hd__a211oi_2 _2215_ (.A1(_0502_),
    .A2(_0674_),
    .B1(_0676_),
    .C1(_0744_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _2235_ (.A1(_0738_),
    ...
    .VPWR(VPWR),
    .X(_0766_));
 sky130_fd_sc_hd__or2_2 _2236_ (.A(_0765_),
    .B(_0766_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_2 _2251_ (.A1(_0569_),
    ...
    .VPWR(VPWR),
    .X(_0781_));
 sky130_fd_sc_hd__o21ba_4 _2252_ (.A1(_0748_),
    .A2(_0764_),
    .B1_N(_0781_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o2bb2a_2 _2294_ (.A1_N(_0781_),
    ...
    .VPWR(VPWR),
    .X(_0822_));
 sky130_fd_sc_hd__o311ai_4 _2295_ (.A1(_0748_),
    .A2(_0764_),
    .A3(_0820_),
    .B1(_0822_),
    .C1(_0795_),
 ...
 sky130_fd_sc_hd__o21ai_1 _2305_ (.A1(_1162_),
    ...
    .VPWR(VPWR),
    .Y(_0832_));
 sky130_fd_sc_hd__nand2_2 _2306_ (.A(_0831_),
    .B(_0832_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0833_));
 sky130_fd_sc_hd__a21o_2 _2307_ (.A1(_0760_),
    .A2(_0833_),
    .B1(_0813_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _2320_ (.A1(_0585_),
    ...
    .VPWR(VPWR),
    .X(_0846_));
 sky130_fd_sc_hd__a31o_4 _2321_ (.A1(_0818_),
    .A2(_0823_),
    .A3(_0835_),
    .B1(_0846_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_2 _2327_ (.A(_0593_),
    ...
    .VPWR(VPWR),
    .Y(_0853_));
 sky130_fd_sc_hd__nor2_4 _2328_ (.A(_0852_),
    .B(_0853_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0854_));
 sky130_fd_sc_hd__nor2_2 _2329_ (.A(_0847_),
    .B(_0854_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0855_));
 sky130_fd_sc_hd__a21o_2 _2330_ (.A1(_0847_),
    .A2(_0854_),
    .B1(_0773_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21a_4 _2335_ (.A1(_0410_),
    ...
    .VPWR(VPWR),
    .X(_0861_));
 sky130_fd_sc_hd__o21ai_4 _2336_ (.A1(_0855_),
    .A2(_0856_),
    .B1(_0861_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_2 _2409_ (.A(_0905_),
    ...
    .VPWR(VPWR),
    .X(_0035_));
 sky130_fd_sc_hd__mux2_1 _2410_ (.A0(net18),
 ...
 sky130_fd_sc_hd__buf_2 _2420_ (.A(_0911_),
    ...
    .VPWR(VPWR),
    .X(_0040_));
 sky130_fd_sc_hd__mux2_2 _2421_ (.A0(net23),
 ...
 sky130_fd_sc_hd__mux2_1 _2423_ (.A0(net24),
    ...
    .VPWR(VPWR),
    .X(_0913_));
 sky130_fd_sc_hd__buf_2 _2424_ (.A(_0913_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0042_));
 sky130_fd_sc_hd__mux2_1 _2425_ (.A0(net26),
    ...
    .VPWR(VPWR),
    .X(_0914_));
 sky130_fd_sc_hd__dlymetal6s2s_1 _2426_ (.A(_0914_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 _2604_ (.A(_0993_),
    ...
    .VPWR(VPWR),
    .X(_0142_));
 sky130_fd_sc_hd__mux2_1 _2605_ (.A0(\rf.registers[0][30] ),
    .A1(net26),
    .S(_0961_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0994_));
 sky130_fd_sc_hd__buf_1 _2606_ (.A(_0994_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _2608_ (.A(\rf.registers[0][31] ),
    ...
    .VPWR(VPWR),
    .X(_0996_));
 sky130_fd_sc_hd__o31a_1 _2609_ (.A1(_0867_),
    .A2(_0874_),
    .A3(_0995_),
    .B1(_0996_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_4 _2770_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(\imem.addr[0] ));
 sky130_fd_sc_hd__dfrtp_4 _2771_ (.CLK(clk),
    .D(_0110_),
    .RESET_B(_0010_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\imem.addr[1] ));
 sky130_fd_sc_hd__dfrtp_4 _2772_ (.CLK(clk),
    .D(_0111_),
    .RESET_B(_0011_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfxtp_1 _2782_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(\rf.registers[0][8] ));
 sky130_fd_sc_hd__dfxtp_4 _2783_ (.CLK(clk),
    .D(_0122_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_1 _2812_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(net45));
 sky130_fd_sc_hd__dfxtp_1 _2813_ (.CLK(clk),
    .D(_0145_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\rf.registers[5][0] ));
 sky130_fd_sc_hd__dfxtp_1 _2814_ (.CLK(clk),
    .D(_0146_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\rf.registers[5][1] ));
 sky130_fd_sc_hd__dfxtp_2 _2815_ (.CLK(clk),
    .D(_0147_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\rf.registers[5][2] ));
 sky130_fd_sc_hd__dfxtp_1 _2816_ (.CLK(clk),
    .D(_0148_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\rf.registers[5][3] ));
 sky130_fd_sc_hd__dfxtp_1 _2817_ (.CLK(clk),
    .D(_0149_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_1 _2848_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(net38));
 sky130_fd_sc_hd__dfxtp_4 _2849_ (.CLK(clk),
    .D(_0007_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\display.sel[0] ));
 sky130_fd_sc_hd__dfxtp_4 _2850_ (.CLK(clk),
    .D(_0008_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__buf_1 output45 (.A(net45),
    ...
    .VPWR(VPWR),
    .X(seg[6]));
 sky130_fd_sc_hd__buf_4 max_cap46 (.A(_1060_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
